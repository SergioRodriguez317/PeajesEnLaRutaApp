...
public class ManejadorBaseDeDatos extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/mariaiaf.peajesenlaruta/databases/";
    private static String DB_NAME = "Peajes.db";
    ...
    public ManejadorBaseDeDatos() {
        super(PantallaPrincipal.activity, DB_NAME, null, DATABASE_VERSION);
    ...
    public void copyDataBase() throws IOException {
        ...
        InputStream myInput = PantallaPrincipal.activity.getAssets().open(DB_NAME);
